	SUBROUTINE CALCSOUND(N, P, T, R, CAPEOUT)
C
...
C
C from readsound.f specifying the format of the input
C   250   FORMAT(3X,'Pressure (mb)',5X,'Temperature (C)',5X,
C     1    'Mixing Ratio (g/kg)')
C
	PARAMETER (NA=80)
	...
	REAL PAP(NA), NAR(NA), NAP(NA), CAPEOUT
C
